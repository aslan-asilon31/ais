...
<html lang="id">
	<head>
		...
		<!-- Koleksi CSS -->
		<link href="<?= base_url()?>assets/frontend/aset/paket/css/bootstrap.min.css" rel="stylesheet" media="screen">
		<link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/frontend/aset/paket/css/sticky-footer.css" media="all" />
		<link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/frontend/aset/paket/css/icons.css" media="all" />
		<link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/frontend/aset/paket/css/style.css" media="all" />
		<link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/frontend/aset/paket/css/animate.css" media="all" />
		<link rel="stylesheet" type="text/css" href="<?= base_url()?>assets/frontend/aset/paket/css/onebyone.css" media="all" />
		<link href="<?= base_url()?>assets/frontend/aset/css/utama.css" rel="stylesheet" />

		<!-- Favicon -->
		<link rel="shortcut icon" href="<?= base_url()?>assets/frontend/aset/img/favicon.ico" />
	</head>
	<body>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 kiri">
							<strong class="logo"><a href="index.html"><img src="<?= base_url()?>assets/frontend/aset/img/logo.png" alt="Logo"></a></strong>
						</div>
					...
					<div id="onebyone_carousel" class="carousel slide gallery-holder">
						<div class="carousel-inner">
							<div class="item active">
								<img src="<?= base_url()?>assets/frontend/aset/img/01_slide_1.jpg" alt="">
							...
							<div class="item">
								<img src="<?= base_url()?>assets/frontend/aset/img/01_slide_2.jpg" alt="">
								<div class="slide_content">
									<div class="container gambar-gerak">
										<div class="hold-text pull-right">
							...
							<div class="item">
								<img src="<?= base_url()?>assets/frontend/aset/img/01_slide_3.jpg" alt="">
								<div class="slide_content">
									<div class="container gambar-gerak">
										<div class="hold-text pull-right">
						...
						<div class="col-md-8 col-sm-6">
							...
							<div class="container">
								...
								<div class="col-sm-12">
									<blockquote class="blockquote-about">
										<cite class="author pull-left">
											<span class="hold-img"><a href="kabar-sekolah-detail.html"><img src="<?= base_url()?>assets/frontend/aset/paket/images/img165.jpg" alt="image" width="85" height="87"></a></span>
								...
								<div class="col-sm-12">
									<blockquote class="blockquote-about">
										<cite class="author pull-left">
											<span class="hold-img"><a href="kabar-sekolah-detail.html"><img src="<?= base_url()?>assets/frontend/aset/paket/images/img33.jpg" alt="image" width="85" height="87"></a></span>
											<small>Oleh <a href="404.html">Administrator</a></small>
										</cite>
										<div class="block">
											<span class="nook">&nbsp;</span>
								...
								<div class="col-sm-12">
									<blockquote class="blockquote-about">
										<cite class="author pull-left">
											<span class="hold-img"><a href="kabar-sekolah-detail.html"><img src="<?= base_url()?>assets/frontend/aset/paket/images/img166.jpg" alt="image" width="85" height="87"></a></span>
											<small>Oleh <a href="404.html">Administrator</a></small>
										</cite>
										<div class="block">
											<span class="nook">&nbsp;</span>
								...
								<div class="col-sm-12">
									<blockquote class="blockquote-about">
										<cite class="author pull-left">
											<span class="hold-img"><a href="kabar-sekolah-detail.html"><img src="<?= base_url()?>assets/frontend/aset/paket/images/img167.jpg" alt="image" width="85" height="87"></a></span>
											<small>Oleh <a href="404.html">Administrator</a></small>
										</cite>
										<div class="block">
											<span class="nook">&nbsp;</span>
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="crewman crewman-center">
								<div class="frame sambutan" id="kepala-sekolah">
									<div class="hold-line">
										<span class="hold-img">
											<img class="img-circle" src="<?= base_url()?>assets/frontend/aset/img/img103.jpg" alt="image" width="210" height="210">
										</span>
												...
												<ul class="list-partners">
													<li>
														<a href="404.html" title="Dinas Pendidikan">
															<img src="<?= base_url()?>assets/frontend/aset/img/logo-pendidikan.png" alt="image" width="118" height="115">
														</a>
													</li>
													<li><a href="404.html" title="Website Kalimantan Timur"><img src="<?= base_url()?>assets/frontend/aset/img/logo-kaltim.png" alt="image" width="118" height="103"></a></li>
													<li><a href="404.html" title="Pramuka Kaltim"><img src="<?= base_url()?>assets/frontend/aset/img/logo-pramuka.png" alt="image" width="97" height="98"></a></li>
													<li><a href="404.html" title="Kota Palembang"><img src="<?= base_url()?>assets/frontend/aset/img/logo-palembang.png" alt="image" width="89" height="98"></a></li>
													<li><a href="404.html" title="SMKN 1 Berau"><img src="<?= base_url()?>assets/frontend/aset/img/logo-smk.png" alt="image" width="90" height="111"></a></li>
													<li><a href="404.html" title="Persisam Samarinda"><img src="<?= base_url()?>assets/frontend/aset/img/logo-persisam.png" alt="image" width="97" height="98"></a></li>
													<li class="last">&nbsp;</li>
												</ul>
											</li>
										</ul>
		...
		<!-- Koleksi Javascript -->
		<script type="text/javascript" src="<?= base_url()?>assets/frontend/aset/paket/js/jquery-2.0.3.min.js"></script>
		<script type="text/javascript" src="<?= base_url()?>assets/frontend/aset/paket/js/bootstrap.min.js"></script>
		<script src="<?= base_url()?>assets/frontend/aset/paket/js/less.js" type="text/javascript"></script>
		<script type="text/javascript" src="<?= base_url()?>assets/frontend/aset/paket/js/jquery.main.js"></script>
		<!--[if lte IE 9 ]>
			<script type="text/javascript" src="<?= base_url()?>assets/frontend/aset/paket/js/modernizr-1.7.min.js"></script>
			<script type="text/javascript" src="<?= base_url()?>assets/frontend/aset/paket/js/placeholder.js"></script>
		<![endif]-->
		<script src="<?= base_url()?>assets/frontend/aset/paket/js/jquery.onecarousel.min.js"></script>
